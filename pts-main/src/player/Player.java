...
public class Player {
    ...
    public Player(int playerIndex, EvaluateAttack evaluateAttack, MoveQueen moveQueen, EvaluateNumberedCards evaluateNumberedCards, DrawingAndTrashPile drawAndTrashPile){
